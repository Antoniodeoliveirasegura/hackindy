...
// Standalone marketing demo for BoilerIndy (route: /demo). Self-contained and
// data-free — it never touches the backend, so it renders identically in any
// environment. Editorial / bento direction on the Purdue-gold design system.
